...
**Detector info**: This is where you can input the pixel pitch (i.e. size), the distance from the aperture (or Fourier lens, if applicable) to the detector, and the wavelength of light used for illumination. These are used to calculate the size and labels of the scale bars on the images.
